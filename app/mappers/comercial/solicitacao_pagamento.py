...
from app.domain.models.comercial.solicitacao_pagamento import SolicitacaoPagamento
from app.persistence.db.comercial.solicitacao_pagamento_orm import SolicitacaoPagamentoORM
